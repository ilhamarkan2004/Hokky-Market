...
=======
                    <img src="build/assets/carousel/1.png" class="block w-full opacity-75" alt="Wild Landscape" />
>>>>>>> 4ad7c02c3c908936b94743d2dac6b38377e8edb0
                </div>
...
=======
                    <img src="build/assets/carousel/3.png" class="block w-full opacity-75" alt="Exotic Fruits" />
>>>>>>> 4ad7c02c3c908936b94743d2dac6b38377e8edb0
                </div>
            </div>
            <button
...
=======
            ...
            <div
                class="w-[175px] lg:w-72 xl:w-90 border-slate-100 bg-transparent shadow-lg shadow-slate-700 overflow-x-hidden">
                <a class="mb-0.5  flex" href="{{route('produk.show', $barang->id)}}">
                ...
                <div class="px-5 pb-5">
                    <a href="{{route('produk.show', $barang->id)}}">
                        <h5
                            class="text-sm lg:text-lg font-semibold tracking-tight text-gray-900 dark:text-white break-words">
                            {{$barang->nama}}</h5>
                    </a>
                    ...
                    <div class="">
                        ...
                        <form
                            class=" text-slate-200 bg-orange-700 hover:bg-red-200 hover:text-slate-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-1 text-center mt-10 block"
                            method="POST" action="{{route('keranjang.store')}}">
                            @csrf
                            <input type="text" name="id" class="hidden" value="{{$barang->id}}">
                            <button class=" w-full  ">
                                Beli
                            </button>
                        </form>
