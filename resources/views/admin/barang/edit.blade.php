            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="p-8 rounded ">
                        <h1 class="font-medium text-3xl">Edit Barang</h1>
                        ...
                        <form method="POST" action="{{ route('barang.update',$barang) }}" enctype="multipart/form-data">
                            ...
                            <div class="mt-8 grid lg:grid-cols-2 gap-4">
                                <div> <label for="nama"
                                        ...
                                        value="{{ old('nama', $barang->nama) }}" type="text" name="nama" id="nama"
                                ...
                                <div> <label for="stok"
                                        ...
                                        value="{{ old('stok', $barang->stok) }}" type="number" name="stok" id="stok"
                                        min="0"
                                ...
                                <div> <label for="harga"
                                        ...
                                        value="{{ old('harga', $barang->harga) }}" type="number" name="harga" id="harga"
                                        min="0"
                            ...
                            <div class="mt-8"> <label for="deskripsi"
                                ...
                                <textarea placeholder="Deskripsi Barang" name="deskripsi" id="" cols="30" rows="10"
                                    class="w-full bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700" value="{{ old('deskripsi', $barang->deskripsi) }}" ></textarea>
